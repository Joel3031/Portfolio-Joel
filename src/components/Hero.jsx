...
// --- OLD LOCAL IMAGE (COMMENTED OUT) ---
// import profileImg from '../assets/Joel.png';

// --- NEW CLOUDINARY IMAGE ---
const profileImgUrl = "https://res.cloudinary.com/dxodogjmz/image/upload/v1770622299/Joel_hl8xpv.png";
        ...
        <section className="min-h-[100dvh] w-full flex items-center justify-center px-6 md:px-20 relative overflow-hidden bg-midnight pt-24 pb-12 md:py-0">
            ...
            <div className="absolute inset-0 z-0 md:hidden pointer-events-none overflow-hidden">
                <motion.img
                    ...
                    // src={profileImg.src} // --- OLD SRC COMMENTED ---
                    src={profileImgUrl}     // --- NEW CLOUDINARY SRC ---
                    alt="Joel Biju"
                ...
                >
                    <div className="relative w-full max-w-md aspect-[3/4] group flex justify-center">
                        ...
                        <img
                            ...
                            src={profileImgUrl}     // --- NEW CLOUDINARY SRC ---
                            alt="Joel Biju"
                            className="relative z-10 w-full h-full object-cover object-top grayscale sepia brightness-90 contrast-110 group-hover:grayscale-0 group-hover:sepia-0 group-hover:brightness-100 transition-all duration-700 ease-out drop-shadow-2xl"
                        />
